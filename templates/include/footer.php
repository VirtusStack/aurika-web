...
<li><a href="index.php" class="text-light text-decoration-none">Home</a></li>
      ...
      <div class="col-md-3 mb-4">
        ...
        <ul class="list-unstyled">
          ...
          <li><a href="#" class="text-light text-decoration-none">Digital Services</a></li>
          <li><a href="#" class="text-light text-decoration-none">Support & Maintenance</a></li>
    ...
    <div class="text-center mt-4 pt-3 border-top border-secondary">
      &copy; 2025 Aurika. All rights reserved.
    </div>
  </div>
